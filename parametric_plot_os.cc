...
void parametric_plot_os()
{
    ...
    formula_par_attr formula_fit_params = read_text_file("norm","/data/dust/user/paranjpe/af-cms.merged/outputs_wbwb/chunk_0430_wbj_widths_new/0611_norm_vs_width_with_errors_opp_sign_root.txt");
    ...
    */
    ...
    {    
        ...
        string title_intermediate = fit_par + "_opp_sign";
        formula_par_attr formula_fit_params = read_text_file(fit_par,"/data/dust/user/paranjpe/af-cms.merged/outputs_wbwb/chunk_0430_wbj_widths_new/0611_" + fit_par + "_vs_width_with_errors_opp_sign_root.txt");
        ...
        plot_vs_width->Draw();
        c1->Draw();
        //c1->SaveAs("/data/dust/user/paranjpe/af-cms.merged/outputs_wbwb/chunk_0430_wbj_widths_new/" + "norm" + "_vs_width_os_parametric_cc.png");
        string os_path = "/data/dust/user/paranjpe/af-cms.merged/outputs_wbwb/chunk_0430_wbj_widths_new/" + fit_par + "_vs_width_os_parametric_cc.png";
    ...
    RooFormulaVar *norm_os, *sigma_os, *alpha_os, *power_os;
    for(int i=0;i<4;i++)
    {
        ...
        if(i==0)
        {
            norm_os = new RooFormulaVar(title_intermediate.c_str(), title_intermediate.c_str(), formula_fit_params.formula_string.c_str(), RooArgList(args_inter));
        }
        else if(i==1)
        {
            sigma_os = new RooFormulaVar(title_intermediate.c_str(), title_intermediate.c_str(), formula_fit_params.formula_string.c_str(), RooArgList(args_inter));
        }
        else if(i==2)
        {
            alpha_os = new RooFormulaVar(title_intermediate.c_str(), title_intermediate.c_str(), formula_fit_params.formula_string.c_str(), RooArgList(args_inter));
        }
        else if(i==3)
        {
            power_os = new RooFormulaVar(title_intermediate.c_str(), title_intermediate.c_str(), formula_fit_params.formula_string.c_str(), RooArgList(args_inter));
        }
    ...
    RooFormulaVar reverse_crystalball{"reverse_crystalball", reverse_crystalballFormula, {mass, mean_mass, *norm_os, *sigma_os, *alpha_os, *power_os}};
    //RooFormulaVar reverse_crystalball{"reverse_crystalball", reverse_crystalballFormula, {mass, mean_mass, norm_os, sigma_os, alpha_os, power_os}};
    ...
    string os_mass_path = "/data/dust/user/paranjpe/af-cms.merged/outputs_wbwb/chunk_0430_wbj_widths_new/mass_vs_width_os_parametric_cc.png";
    ...
    RooRealVar mass{"mass", "mass", 0.0, 1000.0};
    RooRealVar mean_mass{"mean_mass", "mean_mass", 172.5};
    RooRealVar norm_os{"norm_os", "norm_os", 16162.615598692373};
    RooRealVar sigma_os{"sigma_os", "sigma_os", 25.813359533637403};
    RooRealVar alpha_os{"alpha_os", "alpha_os", -1.1465359605047318};
    RooRealVar power_os{"power_os", "power_os", 4.404586573118257};

    //model = ROOT.RooGenericPdf("reverse_crystalball", reverse_crystalballFormula, (mass, mean_mass, norm_os, sigma_os, alpha_os, power_os))
    //RooGenericPdf reverse_crystalball{"reverse_crystalball", reverse_crystalballFormula, {mass, mean_mass, norm_os, sigma_os, alpha_os, power_os}};
    //RooAbsPdf reverse_crystalball{"reverse_crystalball", reverse_crystalballFormula, {mass, mean_mass, norm_os, sigma_os, alpha_os, power_os}};
    RooFormulaVar reverse_crystalball{"reverse_crystalball", reverse_crystalballFormula, {mass, mean_mass, norm_os, sigma_os, alpha_os, power_os}};
