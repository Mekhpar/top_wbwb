...
def exponential(x,p):
    ...
    y = norm*ROOT.TMath.Exp(-coeff*x) + shift
    return y
...
def stacked_bars(x, counts, labels, colors, order, ax):
    ...
    print("Whole stacked bin counts?")
    #print(ax.stackplot(x, counts, labels=labels, colors=colors, step="post"))
    '''
...
def plot_counts_mc(init_time, cats, cat_labels, hist, hist_og, x, config, sysunc, ax, plot_signal):
    ...
    if len(cats) == 6:
        ...
        net_mass = ROOT.TH1D("net_mass","net_mass",len(x.edges[:-1]),x.edges[:-1])
        #'''
        for i in range(0,len(x.edges[:-1])):
            print("Number of bins",i)
            net_mass.SetBinContent(i+1,bar_content[i])
            print("Bin content",net_mass.GetBinContent(i+1))
        #'''
        print(net_mass)
        '''
        fit = ROOT.TF1("fit",voigt,100,400,4)
        fit.SetParNames("norm","mean","sigma","width")
        fit.SetParameters(10.0, 172.5, 20.0, 1.3)
        '''

        #fit = ROOT.TF1("fit",landau,100,400,3)
        #fit = ROOT.TF1("fit",landau,100,600,3)

        #fit.SetParLimits(1,171.5,173.5)
        #fit.SetParLimits(1,172,173)
        #fit.FixParameter(1,172.5)

        '''
        fit = ROOT.TF1("fit",poly_exp,30,200,5)
        fit.SetParNames("shift","exp","cubic","quadratic","linear")
        fit.SetParameters(0.0, 1.0, 1.0, 1.0, 1.0)
        '''

        '''
        #fit = ROOT.TF1("fit",poly_exp,30,200,3)
        fit = ROOT.TF1("fit",poly_exp,30,200,4)
        #fit.SetParNames("shift","exp","linear")
        fit.SetParNames("shift","exp","quadratic","linear")
        fit.SetParameters(0.0, 1.0, 1.0, 1.0)
        '''
        ...
        #fit_gauss.Draw("same")
        #print("Drew fit_gauss")

        #c1.SetLogy()
        #c1.Print("/data/dust/user/paranjpe/af-cms.merged/outputs_wbwb/chunk_0430_wbj_widths_new/width_" + str(args.width_num) + "/net_mass_"+ cats[0] + cats[1] + cats[2] + cats[3] + cats[4] + cats[5] + "_gauss_power_law_border.png")     

        #c1.Print("/data/dust/user/paranjpe/af-cms.merged/outputs_wbwb/chunk_0528_wbj/width_" + str(args.width_num) + "/net_mass_"+ cats[0] + cats[1] + cats[2] + cats[3] + cats[4] + cats[5] + "_gauss_power_law_border.png")     
        c1.Print("/data/dust/user/paranjpe/af-cms.merged/outputs_wbwb/chunk_0528_wbj/width_" + str(args.width_num) + "/net_mass_"+ cats[0] + cats[1] + cats[2] + cats[3] + cats[4] + cats[5] + "_crystalball.png")     
        #c1.Print("/data/dust/user/paranjpe/af-cms.merged/outputs_wbwb/chunk_0430_wbj_widths_new/width_" + str(args.width_num) + "/net_mass_"+ cats[0] + cats[1] + cats[2] + cats[3] + cats[4] + cats[5] + "_crystalball_different.png")     
        #c1.Print("/data/dust/user/paranjpe/af-cms.merged/outputs_wbwb/chunk_0430_wbj_widths_new/width_" + str(args.width_num) + "/net_mass_"+ cats[0] + cats[1] + cats[2] + cats[3] + cats[4] + cats[5] + "_crystalball_original.png")     
        c1.SetLogy()

        #c1.Print("/data/dust/user/paranjpe/af-cms.merged/outputs_wbwb/chunk_0430_wbj_widths_new/width_" + str(args.width_num) + "/net_mass_"+ cats[0] + cats[1] + cats[2] + cats[3] + cats[4] + cats[5] + "_gauss_power_law_border_log_y.png")     
        #c1.Print("/data/dust/user/paranjpe/af-cms.merged/outputs_wbwb/chunk_0528_wbj/width_" + str(args.width_num) + "/net_mass_"+ cats[0] + cats[1] + cats[2] + cats[3] + cats[4] + cats[5] + "_gauss_power_law_border_log_y.png")
        c1.Print("/data/dust/user/paranjpe/af-cms.merged/outputs_wbwb/chunk_0528_wbj/width_" + str(args.width_num) + "/net_mass_"+ cats[0] + cats[1] + cats[2] + cats[3] + cats[4] + cats[5] + "_crystalball_log_y.png")     
        #c1.Print("/data/dust/user/paranjpe/af-cms.merged/outputs_wbwb/chunk_0430_wbj_widths_new/width_" + str(args.width_num) + "/net_mass_"+ cats[0] + cats[1] + cats[2] + cats[3] + cats[4] + cats[5] + "_crystalball_different_log_y.png")     
        #c1.Print("/data/dust/user/paranjpe/af-cms.merged/outputs_wbwb/chunk_0430_wbj_widths_new/width_" + str(args.width_num) + "/net_mass_"+ cats[0] + cats[1] + cats[2] + cats[3] + cats[4] + cats[5] + "_crystalball_original_log_y.png")     
        c1.Close()
