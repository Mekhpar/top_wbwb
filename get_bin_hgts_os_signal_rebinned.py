...
def plot_counts_mc(init_time, cats, cat_labels, hist, hist_og, x, config, sysunc, ax, plot_signal):
    ...
    if len(cats) == 6:
        ...
        #fit_gauss_rev_gauss.SetParameters(1575, 210, 172.5, 42.7, 2470)
        #fit_gauss_rev_gauss.SetParameters(1575, 210, 172.5, 25, 2470)
        fit_gauss_rev_gauss.SetParNames("norm", "alpha", "mean", "sigma", "rev_mean")
        fit_gauss_rev_gauss.SetParameters(1575, 185, 172.5, 25, 2700)
        #fit_gauss_rev_gauss.FixParameter(0,1575)
        ...
        net_mass = ROOT.TH1D("net_mass","Opposite sign signal fit",len(new_x_edges[:-1]),new_x_edges[:-1])
        net_mass_error = ROOT.TH1D("net_mass","Opposite sign signal fit",len(new_x_edges[:-1]),new_x_edges[:-1])
        ...
        #net_mass_error.GetYaxis().SetRangeUser(10000,15000)
        #net_mass_error.GetYaxis().SetRangeUser(0.4,25000)
        ...
        #fit_crystalball.SetParameters(1575, 210, 172.5, 42.7, 2470)
        #fit_crystalball.SetParameters(1575, 210, 172.5, 25, 2470)
        fit_crystalball.SetParNames("norm", "mean", "sigma", "alpha", "power")
        fit_crystalball.SetParameters(1575*20, 172.5, 25, -1, 0.75)
        #fit_crystalball.FixParameter(0,1575)
        ...
        fit_crystalball.SetParLimits(2,18,60)
        ...
        #c1.SetLogy()
        c1.Print("/data/dust/user/paranjpe/af-cms.merged/outputs_wbwb/chunk_0430_wbj_widths_new/width_" + str(args.width_num) + "/net_mass_"+ cats[0] + cats[1] + cats[2] + cats[3] + cats[4] + cats[5] + "_crystalball_new_20GeV_bins_signal.png")     
        c1.Print("/data/dust/user/paranjpe/af-cms.merged/outputs_wbwb/chunk_0430_wbj_widths_new/width_" + str(args.width_num) + "/net_mass_"+ cats[0] + cats[1] + cats[2] + cats[3] + cats[4] + cats[5] + "_crystalball_new_20GeV_bins_signal.C")     

        #Zoomed in
        net_mass_error.GetXaxis().SetRangeUser(500,1000)
        net_mass_error.GetYaxis().SetRangeUser(0,20)

        c1.Print("/data/dust/user/paranjpe/af-cms.merged/outputs_wbwb/chunk_0430_wbj_widths_new/width_" + str(args.width_num) + "/tail_zoomed_net_mass_"+ cats[0] + cats[1] + cats[2] + cats[3] + cats[4] + cats[5] + "_crystalball_new_20GeV_bins_signal.png")     
        c1.Print("/data/dust/user/paranjpe/af-cms.merged/outputs_wbwb/chunk_0430_wbj_widths_new/width_" + str(args.width_num) + "/tail_zoomed_net_mass_"+ cats[0] + cats[1] + cats[2] + cats[3] + cats[4] + cats[5] + "_crystalball_new_20GeV_bins_signal.C")     
        ...
        net_mass_error.GetYaxis().SetRangeUser(0.06,30000)


        #Added June 7 for width 21 to match the axis with width 14
        pad_upper.RangeAxis(0,10000,1000,15000)

        c1.Print("/data/dust/user/paranjpe/af-cms.merged/outputs_wbwb/chunk_0430_wbj_widths_new/width_" + str(args.width_num) + "/net_mass_"+ cats[0] + cats[1] + cats[2] + cats[3] + cats[4] + cats[5] + "_crystalball_new_log_y_20GeV_bins_signal.png")     
        c1.Print("/data/dust/user/paranjpe/af-cms.merged/outputs_wbwb/chunk_0430_wbj_widths_new/width_" + str(args.width_num) + "/net_mass_"+ cats[0] + cats[1] + cats[2] + cats[3] + cats[4] + cats[5] + "_crystalball_new_log_y_20GeV_bins_signal.C")     
