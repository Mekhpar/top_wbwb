...
def plot_counts_mc(init_time, cats, cat_labels, hist, hist_og, x, config, sysunc, ax, plot_signal):
    ...
    if len(cats) == 6:
        ...
        net_mass_error = ROOT.TH1D("net_mass","Same sign bkg fit",len(new_x_edges[:-1]),new_x_edges[:-1])
        ...
        fit_crystalball_gauss = ROOT.TF1("fit_crystalball_gauss",crystalball_gauss,lower_limit,upper_limit,6)
        fit_crystalball_gauss.SetParNames("norm", "mean", "sigma", "alpha", "power", "narrow_sigma")
        fit_crystalball_gauss.SetParameters(13492, 140, 100, -1.1355, 10, 25)
        fit_crystalball_gauss.SetParLimits(0,net_mass.GetMaximum()-100,net_mass.GetMaximum()+100)
        fit_crystalball_gauss.FixParameter(1,140)
        ...
        c1.Print("/data/dust/user/paranjpe/af-cms.merged/outputs_wbwb/chunk_ttbar_tw_wjets_0508/net_mass_"+ cats[0] + cats[1] + cats[2] + cats[3] + cats[4] + cats[5] + "_crystalball_gauss_new.png")     
        c1.Print("/data/dust/user/paranjpe/af-cms.merged/outputs_wbwb/chunk_ttbar_tw_wjets_0508/net_mass_"+ cats[0] + cats[1] + cats[2] + cats[3] + cats[4] + cats[5] + "_crystalball_gauss_new.C")     
        ...
        c1.Print("/data/dust/user/paranjpe/af-cms.merged/outputs_wbwb/chunk_ttbar_tw_wjets_0508/net_mass_"+ cats[0] + cats[1] + cats[2] + cats[3] + cats[4] + cats[5] + "_crystalball_gauss_new_log_y.png")     
        c1.Print("/data/dust/user/paranjpe/af-cms.merged/outputs_wbwb/chunk_ttbar_tw_wjets_0508/net_mass_"+ cats[0] + cats[1] + cats[2] + cats[3] + cats[4] + cats[5] + "_crystalball_gauss_new_log_y.C")     
