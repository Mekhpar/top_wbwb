...
def plot_counts_mc(init_time, cats, cat_labels, hist, hist_og, x, config, sysunc, ax, plot_bkg_choice):
    ...
    if len(cats) == 6:
        ...
        c1.Print("/data/dust/user/paranjpe/af-cms.merged/outputs_wbwb/chunk_ttbar_tw_wjets_0508/net_mass_"+ cats[0] + cats[1] + cats[2] + cats[3] + cats[4] + cats[5] + "_crystalball_ttbar_tW.png")     
        c1.Print("/data/dust/user/paranjpe/af-cms.merged/outputs_wbwb/chunk_ttbar_tw_wjets_0508/net_mass_"+ cats[0] + cats[1] + cats[2] + cats[3] + cats[4] + cats[5] + "_crystalball_ttbar_tW.C")     

        #c1.SetLogy()
        pad_upper.SetLogy()

        c1.Print("/data/dust/user/paranjpe/af-cms.merged/outputs_wbwb/chunk_ttbar_tw_wjets_0508/net_mass_"+ cats[0] + cats[1] + cats[2] + cats[3] + cats[4] + cats[5] + "_crystalball_log_y_ttbar_tW.png")
        c1.Print("/data/dust/user/paranjpe/af-cms.merged/outputs_wbwb/chunk_ttbar_tw_wjets_0508/net_mass_"+ cats[0] + cats[1] + cats[2] + cats[3] + cats[4] + cats[5] + "_crystalball_log_y_ttbar_tW.C")     
